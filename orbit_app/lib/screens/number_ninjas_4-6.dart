...
class NumberNinjas1 extends StatefulWidget {
  final String ageGroup;
  const NumberNinjas1({Key? key, required this.ageGroup}) : super(key: key);

  @override
  _NumberNinjasState createState() => _NumberNinjasState();
}

class _NumberNinjasState extends State<NumberNinjas1>
  ...
  int num1 = 0;
  int num2 = 0;
  String operator = '+'; // Always set to addition
  int correctAnswer = 0;
